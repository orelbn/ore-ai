/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 7b884d221d3f5befccec250455b6646f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "OAUTH_GOOGLE_CLIENT_ID" | "OAUTH_GOOGLE_CLIENT_SECRET" | "MCP_INTERNAL_SHARED_SECRET" | "MCP_SERVER_URL" | "AGENT_PROMPT_KEY" | "GOOGLE_GENERATIVE_AI_API_KEY" | "LOCAL_TEST_AUTH_ENABLED">> {}
}
